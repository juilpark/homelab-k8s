...
현재 구상 중인 네트워크와 노드 배치는 아래 다이어그램과 [`00-topology/`](./00-topology) 폴더에서 관리합니다.

![Homelab topology](./00-topology/homelab-topology.drawio.png)

- 원본 편집 파일: [`00-topology/homelab-topology.drawio`](./00-topology/homelab-topology.drawio)
- 보조 설명 문서: [`00-topology/README.md`](./00-topology/README.md)
...
실제 부트스트랩 및 적용 순서는 [`01-talos-os/README.md`](./01-talos-os/README.md)에 단계별로 정리하고 있습니다.
클러스터가 살아난 뒤의 Kubernetes add-on 구성은 [`02-kubernetes/README.md`](./02-kubernetes/README.md)와 그 아래 단계별 문서에서 이어서 정리합니다.
...
- Kubernetes 후속 구성 단계 문서 작성 진행 중
...
2. [`00-topology/`](./00-topology)에서 네트워크와 노드 배치를 확인합니다.
3. [`01-talos-os/README.md`](./01-talos-os/README.md)에서 Talos 적용 절차를 봅니다.
4. [`02-kubernetes/README.md`](./02-kubernetes/README.md)에서 단계별 Kubernetes 후속 구성 문서를 봅니다.
5. [`01-talos-os/configs/`](./01-talos-os/configs)에서 node patch 파일을 참고합니다.
...
|   |-- 03-metallb.md
|   |-- 04-traefik.md
|   `-- 05-domain-cloudflare-external-dns.md
|-- 01-talos-os
|   |-- README.md
|   `-- configs
`-- topology
...
- Talos 적용 후 검증 절차 정리
- Cilium 설치 및 동작 메모
- MetalLB / Traefik 구성 기록
- 스토리지 연동 메모
- 처음부터 따라 할 수 있는 newcomer-friendly 가이드

## 참고 문서

- Talos bootstrap 메모: [`01-talos-os/README.md`](./01-talos-os/README.md)
- Kubernetes add-on 메모: [`02-kubernetes/README.md`](./02-kubernetes/README.md)
- Cilium 단계 문서: [`02-kubernetes/01-cilium.md`](./02-kubernetes/01-cilium.md)
- Metrics Server 단계 문서: [`02-kubernetes/02-metrics-server.md`](./02-kubernetes/02-metrics-server.md)
- MetalLB 단계 문서: [`02-kubernetes/03-metallb.md`](./02-kubernetes/03-metallb.md)
- Traefik 단계 문서: [`02-kubernetes/04-traefik.md`](./02-kubernetes/04-traefik.md)
- Domain + ExternalDNS 단계 문서: [`02-kubernetes/05-domain-cloudflare-external-dns.md`](./02-kubernetes/05-domain-cloudflare-external-dns.md)
- 토폴로지 자료: [`00-topology/`](./00-topology)
